...
public class CustomVisitor : AbaScriptBaseVisitor<object>
{
    ...
    public override object VisitFactor(AbaScriptParser.FactorContext context)
    {
        return context switch
        {
            ...
            AbaScriptParser.VariableOrArrayAccessContext variableOrArrayAccessContext =>
                VisitVariableOrArrayAccess(variableOrArrayAccessContext),
