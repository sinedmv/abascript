...
public partial class AbaScriptBaseVisitor<Result> : AbstractParseTreeVisitor<Result>, IAbaScriptVisitor<Result> {
	...
	/// <param name="context">The parse tree.</param>
	/// <return>The visitor result.</return>
	public virtual Result VisitUnaryMinus([NotNull] AbaScriptParser.UnaryMinusContext context) { return VisitChildren(context); }
	...
	/// <summary>
	/// Visit a parse tree produced by the <c>FunctionalCall</c>
	/// labeled alternative in <see cref="AbaScriptParser.factor"/>.
	/// <para>
	/// The default implementation returns the result of calling <see cref="AbstractParseTreeVisitor{Result}.VisitChildren(IRuleNode)"/>
	/// on <paramref name="context"/>.
	...
	/// <param name="context">The parse tree.</param>
	/// <return>The visitor result.</return>
	public virtual Result VisitFunctionalCall([NotNull] AbaScriptParser.FunctionalCallContext context) { return VisitChildren(context); }
