...
public interface IAbaScriptListener : IParseTreeListener {
	...
	/// </summary>
	/// <param name="context">The parse tree.</param>
	void EnterUnaryMinus([NotNull] AbaScriptParser.UnaryMinusContext context);
	/// <summary>
	/// Exit a parse tree produced by the <c>UnaryMinus</c>
	/// labeled alternative in <see cref="AbaScriptParser.factor"/>.
	/// </summary>
	/// <param name="context">The parse tree.</param>
	void ExitUnaryMinus([NotNull] AbaScriptParser.UnaryMinusContext context);
	...
	/// </summary>
	/// <param name="context">The parse tree.</param>
	void EnterFunctionalCall([NotNull] AbaScriptParser.FunctionalCallContext context);
	/// <summary>
	/// Exit a parse tree produced by the <c>FunctionalCall</c>
	/// labeled alternative in <see cref="AbaScriptParser.factor"/>.
	/// </summary>
	/// <param name="context">The parse tree.</param>
	void ExitFunctionalCall([NotNull] AbaScriptParser.FunctionalCallContext context);
