...
public interface IAbaScriptVisitor<Result> : IParseTreeVisitor<Result> {
	...
	/// <param name="context">The parse tree.</param>
	/// <return>The visitor result.</return>
	Result VisitUnaryMinus([NotNull] AbaScriptParser.UnaryMinusContext context);
	...
	/// <param name="context">The parse tree.</param>
	/// <return>The visitor result.</return>
	Result VisitFunctionalCall([NotNull] AbaScriptParser.FunctionalCallContext context);
